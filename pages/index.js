  ...
  return (
    <div>
      <div className="Landing">
        ...
        <center>
          <h2 className="shera-text">Create. AchievmorAI is that simple</h2>
            ...
            <div className="Home_option-content__8H3v6 d-flex gap-3">
              ...
              <div className="d-flex flex-column">
                <div className="Home_card___LpL1  Home_disabled__jP87C">
                  ...
                  >
                    <span>
                      Hold 10M $AchievmorAI
                      <br />
                      <br />
                      or
                      <br />
                      <br />
                      subscribe to AchievmorAI Pro to unlock
                    </span>
                  </span>
                  <img
          ...
          <div className="Home_center__4BFgC">
            ...
            <div className="Home_text-home_right__qX0HZ ctx">
              ...
              <div className="Home_child_title__VSGqN ul-l">
                ...
                <span className="Home_b__EFp3k">AchievmorAI</span>
          ...
          >
            <div className="ctr">
              ...
              <div className="Home_child_title__VSGqN">
                Join AchievmorAI's thriving worldwide community and secure your
                ownership in the future of AI by holding $AchievmorAI
              </div>
              <div className="Home_join_title__hBbaj">
